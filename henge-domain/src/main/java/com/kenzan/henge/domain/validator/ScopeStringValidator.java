 ...
 */
public class ScopeStringValidator implements ConstraintValidator<CheckScopeString, String> {
    
    @Override
    public void initialize(CheckScopeString annotation) {
    ...
    public boolean isValid(String str, ConstraintValidatorContext constraintContext) {
        ...
        return ScopeUtils.validateScopeString(str);
    }
