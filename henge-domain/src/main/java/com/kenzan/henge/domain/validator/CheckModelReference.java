...
@Constraint(validatedBy = {CheckReferenceValidator.class, CheckReferenceCollectionValidator.class})
@Documented
public @interface CheckModelReference {
    /**
     * @return the error message if invalid
     */
    String message() default "the reference points to a non existing Model Object";
    ...
    /**
     * @return the model reference class to validate
     */
    Class<?> value();
}
