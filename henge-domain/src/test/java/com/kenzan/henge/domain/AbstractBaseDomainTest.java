...
public abstract class AbstractBaseDomainTest {
	...
	/**
	 * Helper method to load a JSON file into a String object.
	 * @param fileName
	 * @param charset
	 * @return
	 */
	protected String readFile(String fileName, Charset charset) {
    	try {
